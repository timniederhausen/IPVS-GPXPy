 ...
 */
mutable_tile_data<double> trsv(const const_tile_data<double>& L, const mutable_tile_data<double>& a, int N, BLAS_TRANSPOSE transpose_L);
 ...
 */
mutable_tile_data<double> dot_diag_syrk(const const_tile_data<double>& A, const mutable_tile_data<double>& r, int N, int M);
 ...
 * @return updated vector f_r
 */
mutable_tile_data<double> dot_diag_gemm(const const_tile_data<double>& A, const const_tile_data<double>& B, const mutable_tile_data<double>& r, int N, int M);
